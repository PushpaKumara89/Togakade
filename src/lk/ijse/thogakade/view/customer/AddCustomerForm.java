...
import lk.ijse.thogakade.view.orders.PlaceOrderForm;
...
public class AddCustomerForm extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try {
            //if(new CustomerController().(new Customer(txtId.getText(),txtName.getText(),txtAddress.getText(),Double.parseDouble(txtSalary.getText())))){
            if (new CustomerController().addCustomer(new Customer(txtId.getText(), txtName.getText(), txtAddress.getText(), Double.parseDouble(txtSalary.getText())))) {
                JOptionPane.showMessageDialog(this, txtId.getText() + " Added Success");
            }
        } catch (ClassNotFoundException ex) {
            JOptionPane.showMessageDialog(this, "Drivers Not Found");
