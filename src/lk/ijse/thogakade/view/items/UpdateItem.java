...
public class UpdateItem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Item Details");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {            
            if(ItemController.updateItem(new Item(txtItemCode2.getText(),txtDescrep.getText(),Double.parseDouble(txtUnPrice.getText()),Integer.parseInt(txtOhand.getText())))){
               JOptionPane.showMessageDialog(this, "Update Success..."); 
            }else{
                JOptionPane.showMessageDialog(this, "Illegal..."); 
            }
